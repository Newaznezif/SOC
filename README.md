...
| 2 | 📊 | Introduction to SIEM | SIEM basics | [Visit](https://tryhackme.com/room/introtosiem) |
...
| No. | Icon | Title | Focus | Link |
|-----|------|-------|-------|------|
| 1 | 📘 | IR Playbooks | Incident response | [Visit](https://tryhackme.com/room/irplaybooks) |
| 2 | 👨‍💻 | Investigating Windows | Event log forensics | [Visit](https://tryhackme.com/room/investigatingwindows) |
| 3 | 🔍 | Investigating Windows 2.0 | Windows log forensics | [Visit](https://tryhackme.com/room/investigatingwindows2) |
| 4 | 🐧 | Linux Server Forensics | Linux log forensics | [Visit](https://tryhackme.com/room/linuxserverforensics) |
| 5 | 🧠 | Memory Forensics | RAM dump analysis | [Visit](https://tryhackme.com/room/memoryforensics) |
| 6 | 🧊 | Volatility | Memory forensics tooling | [Visit](https://tryhackme.com/room/volatility) |
| 7 | 🎯 | First Shift CTF | SOC challenge exercise | [Visit](https://tryhackme.com/room/first-shift-ctf) |
| 8 | 🕳️ | h4cked | PCAP investigation | [Visit](https://tryhackme.com/room/h4cked) |
| 9 | 🕷️ | Carnage | Traffic analysis challenge | [Visit](https://tryhackme.com/room/carnage) |
| 10 | 📌 | CCT2019 | PCAP forensics competition | [Visit](https://tryhackme.com/room/cct2019) |
| 11 | 📡 | Overpass 2 - Hacked | IR via log analysis | [Visit](https://tryhackme.com/room/overpass2hacked) |
...
| No. | Icon | Title | Focus | Link |
|-----|------|-------|-------|------|
| 1 | 🛡️ | Defensive Security Intro | Defensive security foundation | [Visit](https://tryhackme.com/room/defensivesecurityintroqW) |
| 2 | 🗂️ | File and Hash Threat Intel | Threat intelligence | [Visit](https://tryhackme.com/room/fileandhashthreatintel) |
